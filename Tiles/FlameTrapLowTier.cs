...
{
    public class FlameTrapLowTier : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(150, 100, 100),
                Language.GetOrRegister("Mods.EzrnMoreTraps.Tiles.FlameTrapLowTier", () => "Low-Tier Flame Trap"));
        ...
        {
            yield return new Item(Mod.Find<ModItem>(Items.FlameTrapLowTierItem.GetInternalNameFromStyle(2)).Type); //always drop single item type no matter the style
        }
        ...
        public override void HitWire(int i, int j)
        {
            ...
            int damage = ModContent.GetInstance<EzrnMoreTrapsConfig>().FlameDamage;
            ...
            if (style == 0) // facing right
            {
                if (Wiring.CheckMech(i, j, 200))
                {
                    ...
                    Projectile.NewProjectile(new EntitySource_TileBreak(i, j), spawnPosition, new Vector2(projectileSpeed, 0), ProjectileID.FlamesTrap, damage, 1f, Main.myPlayer);
